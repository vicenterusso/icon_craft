...
// Borrowed from https://github.com/djokobozinov/flutter-icons-helper/blob/main/IconsHelper.dart

class IconsHelper {
  static IconData getRandomIcon() {
    var keys = iconMap.keys.toList();
    var randomIndex = math.Random().nextInt(keys.length);
    return iconMap[keys[randomIndex]]!;
  }
